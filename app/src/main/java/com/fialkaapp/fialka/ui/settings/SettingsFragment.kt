...
class SettingsFragment : Fragment() {
    ...
    private fun showAppInfoDialog() {
        ...
        val content = getString(R.string.settings_app_info_content, version, build.toString())
        showScrollableDialog(getString(R.string.settings_app_info_dialog_title), content)
    }

    private fun showLegalDialog() {
        val content = getString(R.string.settings_legal_content)
        showScrollableDialog(getString(R.string.settings_legal_dialog_title), content)
    }

    private fun showLicensesDialog() {
        val content = getString(R.string.settings_licenses_content)
