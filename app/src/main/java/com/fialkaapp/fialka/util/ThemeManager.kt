...
object ThemeManager {
    ...
    val ALL_THEMES = listOf(
        ThemeInfo(THEME_MIDNIGHT, R.string.theme_midnight, R.style.Theme_Fialka,           0xFF0D0D0D.toInt(), 0xFF00BFA5.toInt()),
        ThemeInfo(THEME_HACKER,   R.string.theme_hacker,   R.style.Theme_Fialka_Hacker,    0xFF000000.toInt(), 0xFF00E676.toInt()),
        ThemeInfo(THEME_PHANTOM,  R.string.theme_phantom,  R.style.Theme_Fialka_Phantom,   0xFF0F0F14.toInt(), 0xFFBB86FC.toInt()),
        ThemeInfo(THEME_AURORA,   R.string.theme_aurora,   R.style.Theme_Fialka_Aurora,    0xFF0D0D0D.toInt(), 0xFFFFB74D.toInt()),
        ThemeInfo(THEME_DAYLIGHT, R.string.theme_daylight, R.style.Theme_Fialka_Daylight,  0xFFF5F5F5.toInt(), 0xFF1976D2.toInt()),
    )
